...
namespace KSeven\Userstamps\Traits;

use KSeven\Userstamps\UserstampsScope;
...
trait Userstamps
{
    ...
    {
        static::creating('KSeven\Userstamps\Listeners\Creating@handle');
        static::updating('KSeven\Userstamps\Listeners\Updating@handle');

        if (static::usingSoftDeletes()) {
            static::deleting('KSeven\Userstamps\Listeners\Deleting@handle');
            static::restoring('KSeven\Userstamps\Listeners\Restoring@handle');
        }
    }
